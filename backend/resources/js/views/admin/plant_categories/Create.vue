<template>
  <div class="modern-form-container">
    <div class="modern-form-card">
      <h2 class="modern-form-title">Add Plant Category</h2>
...
const { createPlantCategory, errors, isLoading } = usePlantCategories();

async function submitForm() {
  try {
    await createPlantCategory({ name: name.value });
