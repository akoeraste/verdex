  ...
  <div class="modern-table-container">
    <div class="modern-table-card">
      <div class="modern-table-header">
        <h5>Permissions</h5>
        <router-link v-if="can('permission-create')" :to="{ name: 'permissions.create' }" class="modern-table-add-btn">
          Add New
        </router-link>
      </div>
        ...
        <table class="modern-table">
          ...
          <tbody>
            <tr v-for="post in permissions.data" :key="post.id">
              ...
              <td>
                <router-link v-if="can('permission-edit')" :to="`/admin/permissions/edit/${post.id}`" class="modern-table-action edit">Edit</router-link>
                <a href="#" v-if="can('permission-delete')" @click.prevent="deletePermission(post.id)" class="modern-table-action delete">Delete</a>
              </td>
            </tr>
          </tbody>
        </table>
