...
class AppleClassifierService {
  static const String _modelPath =
      'assets/model/apple_classifier_mobilenetv3.tflite';
  ...
  Future<bool> loadModel() async {
    try {
      ...
      print('✅ Apple classifier model loaded successfully');
      return true;
    } catch (e) {
      print('❌ Error loading apple classifier model: $e');
  ...
  Future<Map<String, dynamic>> predict(File imageFile) async {
    try {
      ...
      final outputShape = [1, 1]; // Binary classification output
